import type { OpenClawPluginApi } from "openclaw/plugin-sdk/openclaw-mqtt-bridge";
import { emptyPluginConfigSchema } from "openclaw/plugin-sdk/openclaw-mqtt-bridge";
